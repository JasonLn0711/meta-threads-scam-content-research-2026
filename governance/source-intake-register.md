...
| 2026-05-21 | `SRC-META-CONTENT-LIBRARY-API-2026-05-21` | `approved_for_50_item_pilot` | Required preferred official Meta research access route for the CIB case where available; Threads UI/API/export coverage must be recorded per run. |
...
| SRC-META-CONTENT-LIBRARY-API-2026-05-21 | `meta_content_library_ui` / `meta_content_library_api` | CIB Threads scam-content pilot and route-controlled later expansion | `approved_with_limits` | medium | high if official route exposes needed fields | medium | required preferred route | Use official Meta research access first. Record whether Threads content was available through Content Library UI, API, both, or neither; do not replace gaps with scraping. |
