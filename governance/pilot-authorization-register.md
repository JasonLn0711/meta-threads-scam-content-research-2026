...
| 2026-04-23 | Real 50-item Threads pilot | `pending` | Requires completed authorization request, go/no-go checklist, and real-pilot readiness review before collection. |
...
| PILOT-TBD |  |  |  |  |  |  | `pending` |  | Complete `templates/data_authorization_request.md` before changing status. |
