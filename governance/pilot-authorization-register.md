...
| 2026-05-21 | Meta Content Library / API route for CIB/165 Threads scam-content research | `pending` | Preferred official research-grade access route where approved. Requires Research Tools Manager application, CASD review, approved environment, field limits, raw storage outside git, and run records before real collection. |
...
| EVIDENCE-SCOPE-THREADS-PILOT-V1-0014 | 2026-04-25 | stakeholder-approved expanded evidence scope | manual, stakeholder-provided, browser-rendered/session-aware, API-authorized, and automation-assisted under run records | all proposed evidence families approved with run-level limits: redacted stakeholder exemplars, risk-relevant OCR excerpts, controlled-store screenshots, narrow adjacent reply context, visible-link domain/category, redirect/landing evidence, and item-scoped profile/account context | controlled location outside git; exact path outside repo | pilot-only; review after decision memo or by controlled-store retention deadline | `approved_with_limits` | stakeholder / project owner | Gate 0014 completed; run 0015 required before item 0018 collection. |
| META-CONTENT-LIBRARY-API-2026-05-21 | 2026-05-21 | public Threads content via official Meta research tools where eligible | Meta Content Library UI / Content Library API / supplementary Threads API only when approved | public posts and minimized metadata needed for candidate generation, trend, producer-list, narrative, and reviewer-routing analysis; exact fields require run record | approved cleanroom or controlled storage outside git; no raw outputs in repo | defined by Research Tools Manager/CASD/controlled run approval | `pending` | project owner / CASD / CIB stakeholder | Decision 0158 records this as the preferred official route; application prep uses `templates/meta_research_tools_application_prep.md`. |
