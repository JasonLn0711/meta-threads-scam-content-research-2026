...
| `threads_pilot_v1_2026-05_option_a_limited_browser_tranche_run_record_0038.md` | Non-sensitive run record for the stakeholder-approved Option A prospective item 0046-0055 limited browser-session tranche. |
| `checkpoint_0055_stakeholder_decision_record.md` | Repo-safe stakeholder C1/C2/C3 decision record for the 55-record checkpoint before item 0056. |
| `checkpoint_0055_next_decision_handoff.md` | Repo-safe handoff explaining what future decision is required before item 0056 or any new collection. |
