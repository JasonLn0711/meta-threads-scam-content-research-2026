# Checkpoint 0081 Track B Day 1 Batch 0001: Checkpoint Seed Replay

## Purpose

Record the first repo-safe Track B surfaced candidate batch using the `checkpoint-derived seed replay` source arm.
...
| Related decision | `decision-log/0125-record-track-b-day-1-batch-0001-checkpoint-seed-replay.md` |
...
```text
reports/checkpoint-0081-track-b-day-1-batch-0001-primary-review.md
```
...
| `hard_negative_fp_pressure_today` | 0 at primary review |
...
Batch `0001` starts Track B with a low-risk replay path: existing checkpoint-derived signal families are surfaced as candidates without opening new evidence collection.
