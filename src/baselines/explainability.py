...
EXPLANATION_TEMPLATES = {
    ...
    "CODED_ANIMAL_STOCK_LIMIT_UP_GROUP_FUNNEL": "Detected animal-coded low-price stock limit-up group-funnel language in {source}.",
    "MASS_STOCK_COMMAND_LIST_GROUP_FUNNEL": "Detected mass stock-command list and daily-signal group funnel language in {source}.",
    "TRADING_RULES_WEALTH_AUTHORITY_FOLLOW_GATE": "Detected trading-rules wealth-authority follow-gate language in {source}.",
    "BRAND_PATENT_EXTREME_ROI_CONTACT_FUNNEL": "Detected brand/patent extreme-ROI contact-funnel language in {source}.",
