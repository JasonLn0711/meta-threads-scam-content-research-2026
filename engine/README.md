...
The sparse engine is the only decision-support layer. The embedding engine is exploratory only and must not write labels, enforcement recommendations, sparse-feature changes, or final scam determinations.
